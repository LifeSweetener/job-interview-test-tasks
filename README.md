...
<ol>
  <li>
    <p align="jusify">У некоторой компании есть своя сеть и список ip-адресов компьютеров в ней. IP-адреса перечислены в файле <code><a href="1.txt" color="black">1.txt</a></code> (см. файлы этого репозитория)</p>
  </li>
</ol>
</p>
