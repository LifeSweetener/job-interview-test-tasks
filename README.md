  ...
  <li>
    ...
    <ul>
      <li>
        ...
        <p name="third" align="center">3) <code>grkrh[bkooi]asz[krk]</code></p>
      </li>
      <li>
        ...
        <p align="jusify">К примеру, такую технологию поддерживают компьютеры с первым адресом (см. <a href="#first">выше</a>) и с <a name="#third">третьим</a> — <code>g<b>rkr</b>h[bkooi]asz[<b>krk</b>]</code>; и не поддерживает второй компьютер со <a name="#second">вторым</a> ip-шником.</p>
      </li>
    </ul>
    </p>
  </li>
